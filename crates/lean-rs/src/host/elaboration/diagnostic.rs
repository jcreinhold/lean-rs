...
use crate::error::{LeanResult, bound_message};
...
/// [`crate::LEAN_ERROR_MESSAGE_LIMIT`]: the decoder truncates on a UTF-8
...
impl LeanDiagnostic {
    ...
    /// [`crate::LEAN_ERROR_MESSAGE_LIMIT`] bytes on a UTF-8 char
    /// boundary.
    #[must_use]
