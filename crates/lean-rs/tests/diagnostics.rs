...
use lean_rs::host::meta::{MetaCallStatus, infer_type};
use lean_rs::module::{LeanIo, LeanLibrary};
use lean_rs::{
    DiagnosticCapture, LeanCapabilities, LeanDiagnosticCode, LeanElabOptions, LeanError, LeanHost, LeanRuntime,
    LeanSession,
};
...
fn unsupported_code_on_absent_meta_service() {
    ...
    let response = session
        .run_meta(&infer_type(), expr, &lean_rs::host::meta::LeanMetaOptions::new())
