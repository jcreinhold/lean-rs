...
pub struct LeanCapabilities<'lean, 'h> {
    ...
    /// Shim dylib carrying the 13+4 `lean_rs_host_*` `@[export]`
...
impl<'lean, 'h> LeanCapabilities<'lean, 'h> {
    ...
    pub(crate) fn new(
        ...
        // The 13 mandatory + 4 optional `lean_rs_host_*` symbols live
    ...
    /// fixed contract (the 13+4 `lean_rs_host_*` symbols pre-resolved
