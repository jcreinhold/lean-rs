...
//!
//! [`LeanCapabilities`] owns the [`lean_rs::module::LeanLibrary`] and
...
impl<'lean, 'h> LeanCapabilities<'lean, 'h> {
    ...
    /// `None`). The initialized [`lean_rs::module::LeanModule`] is
    ...
    /// [`lean_rs::HostStage::Link`] if the initializer or any of the
