...
fn planned_builder() -> Result<lean_rs_worker_parent::LeanWorkerCapabilityBuilder, Box<dyn std::error::Error>> {
...
fn run_version(
    lease: &mut lean_rs_worker_parent::LeanWorkerSessionLease<'_>,
