...
`ubuntu-latest` nightly, runs the prompt-33 panic-containment fixture and prompt-40 callback
trampoline fixture under ASan, and runs the fuzz target for 120 seconds, on every push to
