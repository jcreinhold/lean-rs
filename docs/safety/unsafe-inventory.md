...
`ubuntu-latest` nightly plus the fuzz target for 120 seconds, on every push to `main`, every
pull request, and a weekly cron. Failure blocks the PR. The stable workspace matrix at
