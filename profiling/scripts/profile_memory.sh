...
run_long_session_mode() {
	...
	LEAN_RS_LONG_SESSION_MODE="$mode" \
		LEAN_RS_LONG_SESSION_IMPORTS="${LEAN_RS_LONG_SESSION_IMPORTS:-1}" \
		...
		LEAN_RS_LONG_SESSION_MAX_RSS_KIB="${LEAN_RS_LONG_SESSION_MAX_RSS_KIB:-1572864}" \
...
run_worker_cycling() {
	...
	LEAN_RS_WORKER_MEMORY_IMPORTS="${LEAN_RS_WORKER_MEMORY_IMPORTS:-6}" \
		...
		LEAN_RS_WORKER_MEMORY_MAX_RSS_KIB="${LEAN_RS_WORKER_MEMORY_MAX_RSS_KIB:-1572864}" \
...
run_pool_memory() {
	...
	LEAN_RS_POOL_MEMORY_MAX_WORKERS="${LEAN_RS_POOL_MEMORY_MAX_WORKERS:-1}" \
		LEAN_RS_POOL_MEMORY_TOTAL_RSS_KIB="${LEAN_RS_POOL_MEMORY_TOTAL_RSS_KIB:-1572864}" \
		LEAN_RS_POOL_MEMORY_PER_WORKER_RSS_KIB="${LEAN_RS_POOL_MEMORY_PER_WORKER_RSS_KIB:-1572864}" \
